- dashboard: test
  ...
  layout: newspaper
  elements:
  - name: add_a_unique_name_1548445191
    title: Untitled Visualization
    model: alexdinsmoor_ramp
    explore: inventory_items
    type: looker_bar
    fields: [products.brand, order_items.selected_period_order_item_count]
    filters:
      order_items.status: Returned
      order_items.date_filter: 1 weeks ago for 1 weeks
    sorts: [order_items.selected_period_order_item_count desc]
    limit: 15
    column_limit: 50
